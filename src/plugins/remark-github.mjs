...
export default function remarkGithub() {
  return (tree) => {
    visit(tree, 'text', (node, index, parent) => {
      ...
      let match;
      while ((match = GITHUB_RE.exec(value)) !== null) {
        ...
        nodes.push({
          type: 'html',
          value: `<a class="github-repo-card" href="${href}" target="_blank" rel="noopener">${GITHUB_ICON_SVG}<span class="github-repo-card__text">${repo}<small>GitHub</small></span></a>`,
        });
